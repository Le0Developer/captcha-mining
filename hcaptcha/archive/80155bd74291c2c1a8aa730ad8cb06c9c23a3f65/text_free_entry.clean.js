...
var vF_7_77_0_ = function (p_4_F_7_77, p_35_F_7_77, p_10_F_7_77, p_3_F_7_77, p_1_F_7_77, p_7_F_7_77, p_7_F_7_772) {
  ...
  function f_1_10_F_7_77(p_13_F_7_77) {
    ...
    this.$icon = this.initComponent(p_3_F_7_77.Graphic, {
      ...
      src: p_13_F_7_77.src,
      fallback: "https://newassets.hcaptcha.com/captcha/v1/80155bd74291c2c1a8aa730ad8cb06c9c23a3f65/challenge/text_free_entry/static/images/" + this.svgIconName + ".png",
      width: this.iconSize,
      fill: this.iconColor
    });
  ...
  function f_1_9_F_7_77(p_5_F_7_77) {
    ...
    this.view.on("focus-frame-element", function (p_1_F_1_1F_7_776) {
      this.emit("focus-frame-element", p_1_F_1_1F_7_776 || "check");
    }.bind(this));
  }
  ...
  f_0_11_F_7_772.prototype.onWindowMove = function (p_1_F_1_1F_7_777) {
    if (this.lastX) {
      var v_2_F_1_1F_7_773 = p_1_F_1_1F_7_777.windowX;
  ...
  f_0_11_F_7_773.prototype.focus = function (p_1_F_1_1F_7_778) {
    if (p_1_F_1_1F_7_778 === "prompt") {
      this.header.focus();
    } else {
      this.focusInput();
    }
  ...
  f_0_11_F_7_773.prototype.lock = function (p_1_F_1_1F_7_779) {
    this.input.lock(p_1_F_1_1F_7_779);
  };
