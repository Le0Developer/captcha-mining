    ...
    try {
      for (var v_3_F_0_15614 = p_7_F_0_1562.widgetMap[Symbol.iterator](), v_1_F_0_15624; !(vLtrue_1_F_0_1562 = (v_1_F_0_15624 = v_3_F_0_15614.next()).done); vLtrue_1_F_0_1562 = true) {
        ...
        if (!v_27_F_0_156.isComplete && !v_27_F_0_156.isFailed && !v_27_F_0_156.isResetting) {
          var v_1_F_0_15625 = v_27_F_0_156.watchcat.seq - 1 - vLN45_1_F_0_156;
  ...
  function f_2_3_F_0_1563(p_14_F_0_156, p_2_F_0_15623) {
    ...
    switch (v_2_F_0_15627) {
      ...
      case v_8_F_0_156.Managed:
        switch (v_2_F_0_15626) {
          ...
          case v_12_F_0_156.Invisible:
            f_2_54_F_0_156(`Invalid value for parameter "size", expected "${v_12_F_0_156.Compact}", "${v_12_F_0_156.Flexible}", or "${v_12_F_0_156.Normal}", got "${v_2_F_0_15626}"`, 2817);
      ...
      case v_8_F_0_156.Invisible:
        ...
        break;
      default:
        f_2_54_F_0_156(`Invalid value for parameter "mode", expected "${v_8_F_0_156.NonInteractive}", "${v_8_F_0_156.Managed}" or "${v_8_F_0_156.Invisible}", got "${v_2_F_0_15627}"`, 2818);
    }
  }
