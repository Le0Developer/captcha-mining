...
var vLSABCDEFGHIJKLMNOPQRST_1_ = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789-_";
var vLS0123456789abcdef_2_ = "0123456789abcdef";
var v_1_ = Math.ceil(10962.666666666666);
function f_0_1_() {
  try {
    const v_3_ = new Uint8Array(12);
    crypto.getRandomValues(v_3_);
    let vLS_1_ = "";
    for (let vLN0_3_ = 0; vLN0_3_ < v_3_.length; vLN0_3_++) {
      const v_2_ = v_3_[vLN0_3_];
      vLS_1_ += vLS0123456789abcdef_2_[v_2_ >>> 4] + vLS0123456789abcdef_2_[v_2_ & 15];
    }
    return vLS_1_;
  } catch {
    return;
...
function f_1_1_(p_8_) {
  try {
    if (typeof p_8_ != "string" || p_8_.length === 0 || p_8_.length > v_1_ || !/^[A-Za-z0-9_-]+$/.test(p_8_)) {
      return;
    }
    const v_4_ = p_8_.length % 4;
    if (v_4_ === 1) {
      return;
    }
    const v_2_2 = vLSABCDEFGHIJKLMNOPQRST_1_.indexOf(p_8_[p_8_.length - 1]);
    if (v_4_ === 2 && (v_2_2 & 15) !== 0 || v_4_ === 3 && (v_2_2 & 3) !== 0) {
      return;
    }
    const v_1_2 = p_8_.replace(/-/g, "+").replace(/_/g, "/") + "=".repeat((4 - v_4_) % 4);
    const vAtob_5_ = atob(v_1_2);
    if (vAtob_5_.length < 31 || vAtob_5_.length > 8222) {
      return;
    }
    const v_4_2 = new Uint8Array(vAtob_5_.length);
    for (let vLN0_4_ = 0; vLN0_4_ < vAtob_5_.length; vLN0_4_++) {
      v_4_2[vLN0_4_] = vAtob_5_.charCodeAt(vLN0_4_);
    }
    if (v_4_2[0] !== 1 || v_4_2[1] !== 0) {
      return undefined;
    } else {
      return v_4_2;
    }
...
var v_1_3 = new TextEncoder("utf-8");
var v_2_3 = new TextDecoder("utf-8");
var v_4_3 = new DataView(new ArrayBuffer(8));
var vA_0_2_ = [];
...
var vC_1_ = class {
  constructor() {
    ...
    const vF_1_6_18_C = p_2_F_1_6C => {
      v_4_3.setBigInt64(0, p_2_F_1_6C, true);
      const v_3_F_1_6C = v_4_3.getFloat64(0, true);
      if (v_3_F_1_6C === 0) {
        return;
      }
      if (!isNaN(v_3_F_1_6C)) {
    ...
    const vF_1_9_4_C = p_9_F_1_9C => {
      ...
      if (typeof p_9_F_1_9C == "number") {
        if (isNaN(p_9_F_1_9C)) {
          ...
          v_4_3.setFloat64(0, p_9_F_1_9C, true);
          return v_4_3.getBigInt64(0, true);
        }
      }
      switch (p_9_F_1_9C) {
        case undefined:
    ...
    const vF_2_1_5_C = (p_1_F_2_1C, p_1_F_2_1C2) => v_2_3.decode(new DataView(this._inst.exports.memory.buffer, p_1_F_2_1C, p_1_F_2_1C2));
    ...
    this.importObject = {
      wasi_snapshot_preview1: {
          ...
          if (p_2_F_4_4C == 1) {
            for (let vLN0_3_F_4_4C = 0; vLN0_3_F_4_4C < p_1_F_4_4C2; vLN0_3_F_4_4C++) {
              ...
              for (let vLN0_3_F_4_4C2 = 0; vLN0_3_F_4_4C2 < v_2_F_4_4C2; vLN0_3_F_4_4C2++) {
                ...
                if (v_3_F_4_4C != 13) {
                  if (v_3_F_4_4C == 10) {
                    const v_1_F_4_4C2 = v_2_3.decode(new Uint8Array(vA_0_2_));
                    vA_0_2_ = [];
        ...
        fd_fdstat_get: () => 0,
        fd_seek: () => 0,
        proc_exit: p_1_F_1_4C => {
          this.exited = true;
          this.exitCode = p_1_F_1_4C;
      ...
      gojs: {
        [vLSRuntimeticks_1_]: () => BigInt(Math.floor((v_1_C + performance.now()) * 1000000)),
        [vLSRuntimesleepTicks_1_]: p_1_F_1_1C => {
          setTimeout(() => {
            if (!this.exited) {
              try {
                this._inst.exports.go_scheduler();
              } catch (e_2_F_0_1F_1_1C) {
                if (e_2_F_0_1F_1_1C !== vO_0_4_) {
                  throw e_2_F_0_1F_1_1C;
                }
              }
            }
          }, Number(p_1_F_1_1C) / 1000000);
        },
        [vLSSyscalljsfinalizeRef_1_]: p_1_F_1_2C2 => {
          const v_7_F_1_2C = p_1_F_1_2C2 & 0xffffffffn;
          if (this._goRefCounts?.[v_7_F_1_2C] !== undefined) {
            this._goRefCounts[v_7_F_1_2C]--;
            if (this._goRefCounts[v_7_F_1_2C] === 0) {
              const v_1_F_1_2C2 = this._values[v_7_F_1_2C];
              this._values[v_7_F_1_2C] = null;
              this._ids.delete(v_1_F_1_2C2);
              this._idPool.push(v_7_F_1_2C);
            }
          } else {
            console.error("syscall/js.finalizeRef: unknown id", v_7_F_1_2C);
          }
        },
        [vLSSyscalljsstringVal_1_]: (p_1_F_2_3C, p_1_F_2_3C2) => {
          p_1_F_2_3C >>>= 0;
          const vVF_2_1_5_C_1_F_2_3C = vF_2_1_5_C(p_1_F_2_3C, p_1_F_2_3C2);
          return vF_1_9_4_C(vVF_2_1_5_C_1_F_2_3C);
        },
        ...
        [vLSSyscalljsvalueLength_1_]: p_1_F_1_1C2 => vF_1_6_18_C(p_1_F_1_1C2).length,
        [vLSSyscalljsvaluePrepar_1_]: (p_2_F_2_4C, p_1_F_2_4C) => {
          const vString_1_F_2_4C = String(vF_1_6_18_C(p_1_F_2_4C));
          const v_2_F_2_4C = v_1_3.encode(vString_1_F_2_4C);
  ...
  async run(p_1_C) {
    ...
    if (this._inst.exports._start) {
      const v_1_C2 = new Promise((p_1_F_2_1C7, p_0_F_2_1C) => {
        this._resolveExitPromise = p_1_F_2_1C7;
      });
      try {
...
var v_5_ = new Map();
var vLN50_1_ = 50;
function f_3_3_(p_1_, p_1_2, p_1_3) {
  const v_4_4 = Math.random().toString(36).slice(2);
  f_1_6_({
    type: "eval-request",
    id: v_4_4,
    argv: p_1_,
    startMouse: p_1_2,
    token: vO_3_13_.token
  });
  return new Promise((p_3_F_2_2, p_1_F_2_2) => {
    if (p_1_3) {
      const vSetTimeout_1_F_2_2 = setTimeout(() => {
        if (v_5_.delete(v_4_4)) {
          p_3_F_2_2(undefined);
        }
      }, vLN50_1_);
      const vF_1_2_2_F_2_2 = p_1_F_1_2F_2_2 => {
        clearTimeout(vSetTimeout_1_F_2_2);
        p_3_F_2_2(p_1_F_1_2F_2_2);
      };
      v_5_.set(v_4_4, {
        resolve: vF_1_2_2_F_2_2,
        reject: () => vF_1_2_2_F_2_2(undefined)
      });
      return;
    }
    v_5_.set(v_4_4, {
...
function f_1_1_2(p_1_4) {
  return f_3_3_(p_1_4, false, false);
}
function f_1_1_3(p_1_5) {
  return f_3_3_(p_1_5, true, true);
}
function f_0_1_2() {
  return f_3_3_("undefined", false, true);
}
function f_0_1_3() {
  let vLfalse_1_ = false;
  const v_2_4 = new Error();
  Object.defineProperty(v_2_4, "stack", {
    get() {
      vLfalse_1_ = true;
      return "";
    }
...
function f_0_1_4() {
  return JSON.stringify(vO_3_13_.mouseAtProbe);
}
async function f_0_1_5() {
  const v_1_4 = await fetch("/.well-known/vercel/security/static/challenge.v2.wasm");
  const v_3_2 = new vC_1_();
  const {
    instance: BV
  } = await WebAssembly.instantiateStreaming(v_1_4, v_3_2.importObject);
  v_3_2.run(BV);
  return {
    instance: BV,
    go: v_3_2
...
async function f_4_1_(p_1_6, p_1_7, p_1_8, p_2_) {
  const vO_2_2_ = {
    method: "POST",
    headers: {
      "x-vercel-challenge-token": p_1_6,
      "x-vercel-challenge-solution": p_1_7,
      "x-vercel-challenge-version": p_1_8
    }
  };
  if (p_2_ !== undefined) {
    vO_2_2_.body = p_2_;
  }
  const v_10_ = await fetch("/.well-known/vercel/security/request-challenge", vO_2_2_);
  if (!v_10_.ok) {
    if (v_10_.headers.get("Cf-Mitigated")) {
      const v_2_5 = v_10_.headers.get("Cf-Ray");
      const v_1_5 = v_2_5 ? "Ray ID: " + v_2_5 : "Challenge blocked by Cloudflare";
      const v_2_6 = new Error(v_1_5);
      v_2_6.__blocked = true;
      throw v_2_6;
    }
    if (v_10_.status === 401 || v_10_.status === 403) {
      const v_2_7 = new Error("Challenge blocked");
      v_2_7.__blocked = true;
      throw v_2_7;
    }
    if (v_10_.status === 404) {
      const v_2_8 = new Error("Challenge not forwarded");
      v_2_8.__blocked = true;
      throw v_2_8;
    }
    if (v_10_.status >= 700) {
      const v_2_9 = new Error(String(v_10_.status));
      v_2_9.__failed = true;
      throw v_2_9;
    }
...
function f_1_6_(p_1_9) {
  vO_3_13_.messagePort?.postMessage(p_1_9);
}
async function f_1_1_4(p_4_) {
  await f_0_1_5();
  let v_4_5;
  try {
    const vF_0_1__2_ = f_0_1_();
    const v_1_6 = vF_0_1__2_ === undefined ? await Solve(p_4_.token) : await Solve(p_4_.token, vF_0_1__2_);
    v_4_5 = JSON.parse(v_1_6);
    const v_1_7 = v_4_5.solution;
    const vF_1_1__1_ = f_1_1_(v_4_5.telemetry);
    await f_4_1_(p_4_.token, v_1_7, p_4_.version, vF_1_1__1_);
    f_1_6_({
      type: "solve-response",
      success: true,
      token: vO_3_13_.token
    ...
    const v_1_8 = e_12_ != null && typeof e_12_ == "object" && "__blocked" in e_12_;
    const v_1_9 = e_12_ != null && typeof e_12_ == "object" && "__failed" in e_12_;
    if (v_1_8) {
      const v_1_10 = e_12_ instanceof Error ? e_12_.message : String(e_12_);
      f_1_6_({
        type: "solve-response",
        success: false,
        blocked: true,
        metadata: v_1_10 ?? undefined,
        token: vO_3_13_.token
      });
    } else if (v_4_5?.badInfo) {
      f_1_6_({
        type: "solve-response",
        success: false,
        blocked: false,
        metadata: v_4_5?.badInfo ?? undefined,
        token: vO_3_13_.token
      });
    } else if (v_1_9) {
      const v_1_11 = e_12_ instanceof Error ? e_12_.message : String(e_12_);
      f_1_6_({
        type: "solve-response",
        success: false,
        blocked: false,
        metadata: v_1_11 ?? undefined,
        token: vO_3_13_.token
      });
    } else {
      f_1_6_({
...
function f_1_1_5(p_9_) {
  if (f_1_1_6(p_9_)) {
    switch (p_9_.data.type) {
      case "solve-request":
        {
          f_1_1_4(p_9_.data);
          break;
      ...
      case "eval-response":
        {
          const v_3_3 = v_5_.get(p_9_.data.id);
          if (!v_3_3) {
            break;
          }
          vO_3_13_.mouseAtProbe = p_9_.data.mouseAtProbe;
          if ("value" in p_9_.data) {
            v_3_3?.resolve(p_9_.data.value);
          } else {
            v_3_3?.reject(p_9_.data.error);
          }
          v_5_.delete(p_9_.data.id);
          break;
        }
      default:
        break;
...
function f_1_1_6(p_2_2) {
  vO_3_13_.token = vO_3_13_.token || p_2_2.data.token;
  return p_2_2.data.token === vO_3_13_.token;
}
self.onmessage = p_1_F_1_3 => {
  const v_2_F_1_3 = p_1_F_1_3.data.port;
  vO_3_13_.messagePort = v_2_F_1_3;
  v_2_F_1_3.onmessage = f_1_1_5;
};
self.setTimeout.e = f_1_1_2;
self.setTimeout.d = f_0_1_3;
self.setTimeout.p = f_0_1_4;
self.setTimeout.s = f_1_1_3;
self.setTimeout.r = f_0_1_2;