...
async function f_3_1_(p_1_2, p_1_3, p_1_4) {
  const v_8_ = await fetch("/.well-known/vercel/security/request-challenge", {
    method: "POST",
    headers: {
...
async function f_1_1_2(p_3_) {
  ...
  try {
    ...
    v_2_8 = JSON.parse(v_1_4);
    const v_1_5 = v_2_8.solution;
    ...
    const v_2_9 = e_6_ != null && typeof e_6_ == "object" && "__blocked" in e_6_;
    const v_1_6 = e_6_ instanceof Error ? e_6_.message : String(e_6_);
    f_1_3_({
      type: "solve-response",
      success: false,
      blocked: v_2_9,
      metadata: v_2_9 ? v_1_6 : v_2_8?.badInfo ?? undefined,
      token: vO_2_8_.token
    });
  }
}
function f_1_1_3(p_8_) {
  if (f_1_1_4(p_8_)) {
    switch (p_8_.data.type) {
      ...
      case "eval-response":
        {
          const v_2_10 = v_3_.get(p_8_.data.id);
          if ("value" in p_8_.data) {
            v_2_10?.resolve(p_8_.data.value);
          } else {
            v_2_10?.reject(p_8_.data.error);
          }
...
function f_1_1_4(p_2_) {
  vO_2_8_.token = vO_2_8_.token || p_2_.data.token;
  return p_2_.data.token === vO_2_8_.token;
}
self.onmessage = p_1_F_1_3 => {
  const v_2_F_1_3 = p_1_F_1_3.data.port;
  vO_2_8_.messagePort = v_2_F_1_3;
