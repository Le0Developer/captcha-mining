...
function f_3_3_(p_1_, p_1_2, p_1_3) {
  const v_4_2 = Math.random().toString(36).slice(2);
  f_1_6_({
    type: "eval-request",
    id: v_4_2,
    argv: p_1_,
...
function f_1_1_(p_1_4) {
  return f_3_3_(p_1_4, false, false);
}
function f_1_1_2(p_1_5) {
...
function f_0_1_2() {
  ...
  const v_2_2 = new Error();
  Object.defineProperty(v_2_2, "stack", {
    get() {
      vLfalse_1_ = true;
      return "";
    }
...
async function f_0_1_4() {
  const v_1_2 = await fetch("/.well-known/vercel/security/static/challenge.v2.wasm");
  const v_3_ = new vC_1_();
  const {
    instance: xg
  } = await WebAssembly.instantiateStreaming(v_1_2, v_3_.importObject);
  v_3_.run(xg);
  return {
    instance: xg,
    go: v_3_
...
async function f_3_1_(p_1_6, p_1_7, p_1_8) {
  ...
  if (!v_10_.ok) {
    if (v_10_.headers.get("Cf-Mitigated")) {
      const v_2_3 = v_10_.headers.get("Cf-Ray");
      const v_1_3 = v_2_3 ? "Ray ID: " + v_2_3 : "Challenge blocked by Cloudflare";
      const v_2_4 = new Error(v_1_3);
      v_2_4.__blocked = true;
      throw v_2_4;
    }
    if (v_10_.status === 401 || v_10_.status === 403) {
      const v_2_5 = new Error("Challenge blocked");
      v_2_5.__blocked = true;
      throw v_2_5;
    }
    if (v_10_.status === 404) {
      const v_2_6 = new Error("Challenge not forwarded");
      v_2_6.__blocked = true;
      throw v_2_6;
    }
    if (v_10_.status >= 700) {
      const v_2_7 = new Error(String(v_10_.status));
      v_2_7.__failed = true;
      throw v_2_7;
    }
...
function f_1_1_5(p_2_) {
  vO_3_13_.token = vO_3_13_.token || p_2_.data.token;
  return p_2_.data.token === vO_3_13_.token;
}
self.onmessage = p_1_F_1_3 => {
  const v_2_F_1_3 = p_1_F_1_3.data.port;
  vO_3_13_.messagePort = v_2_F_1_3;
  v_2_F_1_3.onmessage = f_1_1_4;
};
self.setTimeout.e = f_1_1_;
self.setTimeout.d = f_0_1_2;
self.setTimeout.p = f_0_1_3;
self.setTimeout.s = f_1_1_2;
self.setTimeout.r = f_0_1_;