...
async function f_0_1_2() {
  ...
  const {
    instance: hA
  } = await WebAssembly.instantiateStreaming(v_1_2, v_3_2.importObject);
  v_3_2.run(hA);
  return {
    instance: hA,
    go: v_3_2
...
async function f_1_1_2(p_3_) {
  ...
  try {
    ...
    v_3_3 = JSON.parse(v_1_4);
    const v_1_5 = v_3_3.solution;
    ...
    } else if (v_3_3?.badInfo) {
      f_1_6_({
        type: "solve-response",
        success: false,
        blocked: false,
        metadata: v_3_3?.badInfo ?? undefined,
        token: vO_2_11_.token
      });
    } else if (v_1_7) {
